 ...
 * This file includes the fully working, syntax‑checked layout.
 */
export default function ChatPage() {
  ...
  // 👇 The component returns its JSX here — outside of sendMessage()
  return (
    <main className="flex flex-col items-center justify-start min-h-screen pt-10 px-4">
      ...
      <p className="max-w-md text-gray-500 mb-6 text-center">
        PUT SOME COPY HERE – briefly tell visitors what to do, e.g.
        “Ask about my background, projects, or design approach.”
      </p>
      {/* Chat window */}
